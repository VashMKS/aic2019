...
public class Data {
    ...
    int[] mineDistToBase;       int nMineMax = 10;              int channelsPerMine = 4;

    // Town Info
    int nTown;                  Location[] townLocations;       int[] townsfolk;
    boolean[] townConquered;    int channelsPerTown = 4;
