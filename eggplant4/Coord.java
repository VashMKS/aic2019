...
public class Coord {
    ...
    public UnitType unitType; // default: null
    public Team team;         // default: null
    public int healthLevel;   // default: 0      int ranging 0-9 denoting %HP left, 1 is 10%, 9 is 90%, 0 is 100%
    public int freeSlot;      // default: 0
    public int lastExplored;  // default: 0
